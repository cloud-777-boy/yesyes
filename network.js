    ...
    handleSandUpdate(msg) {
        ...
        if (msg.full) {
            if (typeof this.engine.loadSandChunks === 'function') {
                ...
                console.log('[SAND UPDATE] Loaded full sand snapshot, count:', this.engine.sandParticleCount);
            }
            return;
        }
        ...
        if (typeof this.engine.updateSandChunks === 'function') {
            ...
            console.log('[SAND UPDATE] Updated sand chunks, count:', this.engine.sandParticleCount);
        } else if (typeof this.engine.loadSandChunks === 'function') {
            this.engine.loadSandChunks(msg);
            console.log('[SAND UPDATE] Loaded sand chunks, count:', this.engine.sandParticleCount);
        }
    }
